...
constexpr std::string SVGstrings::nesc = "\n";
constexpr std::string SVGstrings::sttag = "<";
constexpr std::string SVGstrings::entag = "/>";
constexpr std::string SVGstrings::gap = " ";
constexpr std::string SVGstrings::circle_svg = "circle";
constexpr std::string SVGstrings::text_svg = "text";
constexpr std::string SVGstrings::maintagclose = "\n\n\n</svg>";
